;; title: Builder Rewards Contract V3 (Enhanced Fees) - Wednesday
;; version: 3.0.0
;; summary: A Clarity contract for Stacks Builder Challenge with 1 STX fees and 1.5 STX rewards
;; description: Enhanced version with 1 STX check-in fee and 1.5 STX rewards. Restricted to Wednesday.
...
(define-constant required-day u3) ;; Wednesday = 3
