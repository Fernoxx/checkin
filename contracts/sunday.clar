;; title: Builder Rewards Contract V3 (Enhanced Fees) - Sunday
;; version: 3.0.0
;; summary: A Clarity contract for Stacks Builder Challenge with 1 STX fees and 1.5 STX rewards
;; description: Enhanced version with 1 STX check-in fee and 1.5 STX rewards. Restricted to Sunday.
...
(define-constant required-day u0) ;; Sunday = 0
