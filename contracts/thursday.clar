;; title: Builder Rewards Contract V3 (Enhanced Fees) - Thursday
;; version: 3.0.0
;; summary: A Clarity contract for Stacks Builder Challenge with 1 STX fees and 1.5 STX rewards
;; description: Enhanced version with 1 STX check-in fee and 1.5 STX rewards. Restricted to Thursday.
...
(define-constant required-day u4) ;; Thursday = 4
